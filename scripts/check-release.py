...
if "pub const ARCHIVE_VERSION: u32 = 2;" not in portable_source:
    fail("current .meiki archive version 2 is not declared")
...
print(
    ...
    f"version={version} schema={migration_versions[-1]} archive=2"
)
