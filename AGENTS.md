...
- Include repository, issue and pull-request numbers, branch, latest commit, CI state, unresolved feedback, uncovered requirements, required human verification, queue state, and the blocker when blocked.
